...
// const magician_names:string[] = ["David Copperfield", "Harry Houdini", "Dynamo"];

// // Display original list of magicians
// console.log("Original list of magicians:");
// show_magicians(magician_names);

// // Modify the list to make magicians great
// const great_magicians:string[] = make_great([...magician_names]); // we add spreader to shallow copy a list
